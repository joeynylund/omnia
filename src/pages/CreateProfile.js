                ...
                <Container>
                    <div style={{padding:'5% 0px'}}>
                        <center>
                            ...
                            <Button style={{marginTop:'20px',backgroundColor:'#616161',height:'50px',width:'200px'}} onClick={() => setStep(step - 1)} size="lg">Back</Button>
                            <Button style={{marginTop:'20px',backgroundColor:'#242425',height:'50px',width:'200px'}} onClick={() => setStep(step + 1)} size="lg">Next</Button>
                        </center>
                    </div>
                </Container>
            </div>
